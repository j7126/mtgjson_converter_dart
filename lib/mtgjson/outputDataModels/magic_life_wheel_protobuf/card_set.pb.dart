...
class MagicLifeWheelProtobufCardSet extends $pb.GeneratedMessage {
  factory MagicLifeWheelProtobufCardSet({
    $core.String? uuid,
    $core.String? name,
    $core.String? setCode,
  ...
  MagicLifeWheelProtobufCardSet._();

  factory MagicLifeWheelProtobufCardSet.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory MagicLifeWheelProtobufCardSet.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MagicLifeWheelProtobufCardSet',
  ...
  MagicLifeWheelProtobufCardSet clone() =>
      MagicLifeWheelProtobufCardSet()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MagicLifeWheelProtobufCardSet copyWith(
          void Function(MagicLifeWheelProtobufCardSet) updates) =>
      super.copyWith(
              (message) => updates(message as MagicLifeWheelProtobufCardSet))
          as MagicLifeWheelProtobufCardSet;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static MagicLifeWheelProtobufCardSet create() =>
      MagicLifeWheelProtobufCardSet._();
  @$core.override
  MagicLifeWheelProtobufCardSet createEmptyInstance() => create();
  static $pb.PbList<MagicLifeWheelProtobufCardSet> createRepeated() =>
      $pb.PbList<MagicLifeWheelProtobufCardSet>();
  @$core.pragma('dart2js:noInline')
  static MagicLifeWheelProtobufCardSet getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MagicLifeWheelProtobufCardSet>(create);
  static MagicLifeWheelProtobufCardSet? _defaultInstance;
