...
MagicDeckManagerCardSet _$MagicDeckManagerCardSetFromJson(
        Map<String, dynamic> json) =>
    MagicDeckManagerCardSet(
      name: json['name'] as String,
      identifiers: MagicDeckManagerJsonIdentifiers.fromJson(
...
Map<String, dynamic> _$MagicDeckManagerCardSetToJson(
        MagicDeckManagerCardSet instance) =>
    <String, dynamic>{
      'name': instance.name,
